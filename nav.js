...
<div class="navbar-fixed">\
  <ul id="dropdown1" class="dropdown-content">\
    ...
    <ul id="dropdown2" class="dropdown-content" style="color: white;">\
        <li class="us"><a href="us.html">Who Are We</a></li>\
        <li class="cont"><a href="cont.html">Contact Us</a></li>\
    </ul>\
  <nav>\
    <div class="nav-wrapper">\
      <a href="index.html" class="brand-logo" style="font-size: 26px;">&nbsp;AquaBot<br><span style="font-size: 8px; position: relative; top: -40px; left: 6px;">A Product by Innovate Robotics</span></a>\
        ...
        <ul class="collapsible collapsible-accordion">\
          <li>\
            ...
            <div class="collapsible-body">\
              <ul>\
              <li><a href="us.html">Who Are We</a></li>\
